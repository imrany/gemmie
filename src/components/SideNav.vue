    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div class="flex items-center justify-between p-3">
        ...
        <div class="flex gap-2 items-center ml-auto">
          <button
            @click="props.functions.toggleSidebar"
      ...
      >
        ...
        <button
          @click="reload"
          v-if="props.data.chats.length !== 0"
          title="Refresh Page"
          class="w-full flex items-center gap-2 h-[40px] hover:bg-gray-100 rounded-lg px-2"
        >
        ...
        <button
          ...
          "
          title="Delete Chat"
          v-if="props.data.screenWidth < 720 && props.data.chats.length !== 0"
      ...
      >
        <p
          v-if="!props.data.isCollapsed || props.data.screenWidth < 720"
    ...
    <div class="border-t border-gray-200 p-3 bg-gray-100 sticky bottom-0">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-2">
          <div
            class="w-[35px] h-[35px] flex justify-center items-center bg-gray-300 rounded-full"
          >
