...
<template>
    <div class="flex items-center font-light justify-center min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
        <div class="w-full max-w-md max-lg:px-4 p-6">
            <h1 v-if="!showConfirm" class="text-xl font-semibold text-red-600 dark:text-red-500 mb-2">Delete My Account</h1>
            <p v-if="!showConfirm" class="text-sm text-gray-600 dark:text-gray-400 mb-6">
                Please confirm your credentials before deleting your account. <br />
                <b class="font-semibold text-red-700 dark:text-red-400">This action is irreversible.</b>
            </p>

            <!-- Error / Success messages -->
            <div v-if="errorMsg" class="mb-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-md transition-colors duration-200">
                <p class="text-sm text-red-700 dark:text-red-400">{{ errorMsg }}</p>
            </div>

            <div v-if="successMsg" class="mb-4 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-md transition-colors duration-200">
            ...
            <div v-if="showConfirm" class="space-y-4">
                <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-md p-4 transition-colors duration-200">
                    <div class="flex items-start gap-3">
                        <div class="flex-shrink-0 w-6 h-6 bg-yellow-100 dark:bg-yellow-800 rounded-full flex items-center justify-center">
                            <i class="pi pi-exclamation-triangle text-yellow-600 dark:text-yellow-400 text-sm"></i>
                        </div>
                        <div>
                            <h3 class="font-semibold text-yellow-800 dark:text-yellow-400 mb-2">Final Confirmation Required</h3>
                            ...
                            <ul class="text-sm text-yellow-700 dark:text-yellow-300 list-disc list-inside space-y-1 mb-3">
                                ...
                                <li>Remove your account information permanently</li>
                ...
                <div class="flex gap-3">
                    ...
                    <button @click="handleDeleteAccount"
                        ...
                        :class="confirmText.toLowerCase() === 'delete my account' 
