...
export function useAI() {
  ...
  const aiSuggestions = [
    { icon: '📝', label: 'Summarize', action: 'summarize', description: 'Create a concise summary', shortcut: 'Ctrl+Shift+S' },
    { icon: '🔍', label: 'Expand', action: 'expand', description: 'Elaborate on the selected text', shortcut: 'Ctrl+Shift+E' },
    { icon: '✨', label: 'Improve', action: 'improve', description: 'Enhance writing quality', shortcut: 'Ctrl+Shift+I' },
    { icon: '📖', label: 'Simplify', action: 'simplify', description: 'Make text easier to understand', shortcut: 'Ctrl+Shift+P' },
    { icon: '🔄', label: 'Paraphrase', action: 'paraphrase', description: 'Rewrite in different words', shortcut: 'Ctrl+Shift+R' },
    { icon: '🌐', label: 'Translate', action: 'translate', description: 'Translate to different language', shortcut: 'Ctrl+Shift+T' }
  ]
